...
-- Modified with dark neon theme and added label component
...
function lib:CreateWindow(title)
    local window = {
        ...
        -- Changed accent color to a bright neon green
    ...
    local Menu = Create("ScrollingFrame", {
        ...
        -- Darker scrollbar
        ScrollBarImageColor3 = Color3.fromRGB(30, 30, 40),
        BottomImage = "",
        TopImage = "",
        BorderSizePixel = 0
    }, {
    ...
    function window:NewTab(tabTitle)
        ...
        function comp1:AddSection(secTitle)
            ...
            -- NEW FUNCTION: Add Label
            function components:AddLabel(labelText, tooltip)
            ...
            function components:AddButton(buttonText, tooltip, callback)
                tooltip = tooltip or nil
                callback = callback or function() end
            ...
            function components:AddToggle(buttonText, tooltip, default, callback)
                local t1 = {}
                tooltip = tooltip or nil
                t1.State = default or false;
                callback = callback or function() end
                local b1 = Create("TextButton", {
                    -- Darker toggle background
                    BackgroundColor3 = Color3.fromRGB(10, 10, 12),
                    Size = UDim2.new(1, 0, 0, 30),
                    Parent = container,
                    Text = "",
                ...
                local toggle = Create("Frame", {
                    ...
                    Create("UIStroke", {
                        ApplyStrokeMode = 1,
                        Color = t1.State and window.AccentColor or Color3.fromRGB(18, 18, 22)
                    }),
                    Create("UICorner", {
                        CornerRadius = UDim.new(0, 4)
                    }),
                ...
                b1.MouseButton1Click:Connect(function()
                    ...
                    tween(toggle.UIStroke, 0.3, {Color = t1.State and window.AccentColor or Color3.fromRGB(18, 18, 22)})
                end)
                b1.MouseEnter:Connect(function()
                    showTooltip(tooltip)
                end)
                ...
                function t1:SetState(state)
                    ...
                    callback(t1.State)
                    TS:Create(toggle.ImageLabel, TweenInfo.new(t1.State and 0.3 or 0.8, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Size = t1.State and UDim2.new(0, 20, 0, 20) or UDim2.new(0, 0, 0, 0), Position = t1.State and UDim2.new(0.5, -10, 0.5, -10) or UDim2.new(0.5, 0, 0.5, 0)}):Play()
                    tween(toggle.ImageLabel, t1.  -10, 0.5, -10) or UDim2.new(0.5, 0, 0.5, 0)}):Play()
                    tween(toggle.ImageLabel, t1.State and 0.3 or 0.8, {ImageTransparency = t1.State and 0 or 1})
                    tween(toggle.UIStroke, 0.3, {Color = t1.State and window.AccentColor or Color3.fromRGB(18, 18, 22)})
                end
                return t1;
            ...
            function components:AddTextBox(boxTitle, tooltip, placeholder, default, callback)
                ...
                textbox.FocusLost:Connect(function()
                    tween(textbox.UIStroke, 0.3, {Color = Color3.fromRGB(18, 18, 22)})
