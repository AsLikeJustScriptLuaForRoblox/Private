    ...
    function Window:CreateTab(tabName)
        ...
        function Tab:CreateSection(sectionName)
            ...
            function Section:AddDropdown(dropdownText, options, default, callback)
                ...
                DropdownContainer.Size = UDim2.new(1, 0, 0, 32) -- Smaller dropdown
                DropdownContainer.BackgroundTransparency = 1
                DropdownContainer.Parent = SectionContent
                
                local DropdownLabel = Instance.new("TextLabel")
                DropdownLabel.Name = "DropdownLabel"
                DropdownLabel.Size = UDim2.new(1, 0, 0, 16) -- Smaller label
                DropdownLabel.BackgroundTransparency = 1
                DropdownLabel.Text = dropdownText
                DropdownLabel.TextColor3 = Colors.Text
                DropdownLabel.TextSize = 12 -- Smaller text size
                ...
                SelectedText.TextSize = 12 -- Smaller text size
                ...
                DropdownButton.Size = UDim2.new(1, 0, 0, 20) -- Smaller button
                ...
                DropdownButton.TextSize = 12 -- Smaller text size
                ...
                DropdownButtonPadding.PaddingLeft = UDim.new(0, 8) -- Smaller padding
                DropdownButtonPadding.Parent = SelectedText
                
                local DropdownButtonCorner = Instance.new("UICorner")
                DropdownButtonCorner.CornerRadius = UDim.new(0, 3) -- Smaller corner radius
                DropdownButtonCorner.Parent = DropdownButton
                
                local DropdownArrow = Instance.new("ImageLabel")
                DropdownArrow.Name = "DropdownArrow"
                DropdownArrow.Size = UDim2.new(0, 16, 0, 16) -- Smaller arrow
                DropdownArrow.Position = UDim2.new(1, -20, 0, 2)
                ...
                DropdownMenuCorner.CornerRadius = UDim.new(0, 3) -- Smaller corner radius
                ...
                for i, option in ipairs(options) do
                    ...
                    OptionButton.Size = UDim2.new(1, 0, 0, 20) -- Smaller option buttons
                    OptionButton.BackgroundTransparency = 1
                    OptionButton.Text = option
                    OptionButton.TextColor3 = Colors.Text
                    OptionButton.TextSize = 12 -- Smaller text size
                    ...
                    OptionButtonPadding.PaddingLeft = UDim.new(0, 8) -- Smaller padding
                ...
                SafeConnect(DropdownButton.MouseButton1Click, function()
                    pcall(function()
                        isOpen = not isOpen
                        ...
                        if isOpen then
                            ...
                            DropdownMenu:TweenSize(UDim2.new(1, 0, 0, #options * 20), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.2, true)
                            TweenService:Create(DropdownArrow, TweenInfo.new(0.2), {Rotation = 180}):Play()
                            
                            -- No TakeFocus call - it's not valid for ScrollingFrame
                        else
